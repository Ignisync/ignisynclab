...
import { ArrowRight, Target, Eye, Lightbulb, MessageSquare, Code, Rocket } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="text-center p-8 rounded-3xl bg-card border border-border hover-lift"
              >
